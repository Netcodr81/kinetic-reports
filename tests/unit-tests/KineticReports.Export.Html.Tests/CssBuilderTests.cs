...
public class CssBuilderTests
{
    ...
    {
        var style = new AppliedStyle { FontFamily = "Times New Roman", FontSize = 12f };
        var css = BuildStyle(style);
    ...
    {
        var style = new AppliedStyle { FontFamily = "Arial", FontSize = 14f };
        var css = BuildStyle(style);
    ...
    {
        var style = new AppliedStyle { FontFamily = "Arial", FontSize = 12f, FontWeight = FontWeight.Bold };
        var css = BuildStyle(style);
    ...
    {
        var style = new AppliedStyle { FontFamily = "Arial", FontSize = 12f, FontStyle = FontStyleValue.Italic };
        var css = BuildStyle(style);
    ...
    {
        var style = new AppliedStyle { FontFamily = "Arial", FontSize = 12f, TextColor = Color.FromRgb(255, 0, 0) };
        var css = BuildStyle(style);
    ...
    {
        var style = new AppliedStyle { FontFamily = "Arial", FontSize = 12f, Background = Color.FromRgb(0, 255, 0) };
        var css = BuildStyle(style);
    ...
    {
        var style = new AppliedStyle { FontFamily = "Arial", FontSize = 12f, Opacity = 0.5f };
        var css = BuildStyle(style);
    ...
    {
        var style = new AppliedStyle { FontFamily = "Arial", FontSize = 12f, TextAlignment = TextAlignment.Center };
        var css = BuildStyle(style);
    ...
    private static string BuildStyle(AppliedStyle style) => CssBuilder.BuildStyle(style);
}
