namespace KineticReports.Samples.Mvc.DependencyInjection;
...
{
    /// <summary>
    /// Adds the default KineticReports registrations used by the MVC sample.
    /// </summary>
...
public sealed class KeneticReportsBuilder
{
    ...
    /// <summary>
    /// Adds the MVC viewer services.
    /// </summary>
    /// <param name="configure">Optional callback to configure viewer pipeline options.</param>
    public KeneticReportsBuilder AddMvcViewer(Action<ViewerRenderingPipelineOptions>? configure = null)
    {
        Services.AddKineticReportsViewerMvc(viewerOptions =>
        {
