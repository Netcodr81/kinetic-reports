...
/// <summary>
/// Default implementation of <see cref="IReportBuilder"/> that returns an empty band list.
/// Override or replace this with a real bands builder that constructs the report element hierarchy
/// based on the report definition and resolved data sources.
/// </summary>
public sealed class DefaultReportBuilder : IReportBuilder
{
    /// <summary>
    /// Builds report bands from the data context and definition.
    /// </summary>
    /// <remarks>
    ...
    /// - Create the corresponding band element list
    /// </remarks>
